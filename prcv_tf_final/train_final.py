...
###########################修改路径##################################
root_trainIn='data/trainIn_1'#训练集输入路径
root_trainOut='data/trainOut_1'#训练集标签路径
root_verificationIn='data/verificationIn'#验证集输入路径
root_verificationOut='data/verificationOut'#验证集标签路径
